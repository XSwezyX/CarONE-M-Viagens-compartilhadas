...
public class Viagem {
    ...
    public Reserva confirmarReserva(Usuario passageiro, Local embarque, Local desembarque) {
        Reserva reserva = new Reserva(passageiro, this, embarque, desembarque);
        if (aceitaPassageiros) {
